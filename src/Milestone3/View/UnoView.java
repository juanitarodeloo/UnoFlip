...
public class UnoView extends JFrame {
    ...
    private Milestone3.View.InfoPanel infoPanel;  // Info game panel contains the number of player and corresponding information
...
//                }
        ...
        lastMessage = message; // For testing
    }
...
//    }
     ...
     */
    public void updateHandSides(boolean isLight, ArrayList<Milestone3.Model.CardModel> hands){
     ...
     * @param e
     */
    public void updateRoundFinished(Milestone3.Model.UnoFinishEvent e){
     ...
     * @param e
     */
    public void updateGameFinished(Milestone3.Model.UnoFinishEvent e){
     ...
     * @param e
     */
    public void finishConfirm(Milestone3.Model.UnoFinishEvent e){
        UIManager.put("OptionPane.okButtonText", "Ok");
        JOptionPane.showMessageDialog(null,
