...
public class InfoPanel extends JPanel{
    ...
    private Milestone3.UnoController controller;

    private Image backgroundImage;
    public InfoPanel(Milestone3.UnoController controller){
     ...
     * @param players
     */
    public void initPlayerInfo(ArrayList<Milestone3.Model.PlayerModel> players){
        ...
        for (Milestone3.Model.PlayerModel player : players) { // Create player info panel for each player
