...
/**
 *
 As the developer of the UnoModel class, I encountered challenges that limited my ability to test some methods.
 The complexity of these methods, involving intricate interactions and dependencies within the system, made isolating them for testing particularly challenging.
 Additionally, with limited resources in terms of manpower and computational capacity, I had to prioritize testing the most essential functionalities.
 Simulating the specific scenarios required for certain methods also proved difficult, especially those involving random elements
 or complex game states, leading to a focus on testing critical aspects of the code and inevitably leaving some methods less thoroughly examined.
 */