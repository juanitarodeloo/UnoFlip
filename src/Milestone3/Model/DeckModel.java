...
//                this.cards.add(new Milestone3.Model.CardSideModel.CardModel(color, Milestone3.Model.CardSideModel.Type.ZERO));
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    if (isLight) {
                        this.lightSides.add(new Milestone3.Model.CardSideModel(color, Milestone3.Model.CardSideModel.Type.SKIP));
                        ...
                        this.darkSides.add(new Milestone3.Model.CardSideModel(color, CardSideModel.Type.FLIP));
                    }
                }
            }
        }
        ...
        for (int i = 0; i < 4; i++) {
            this.lightSides.add(new Milestone3.Model.CardSideModel(Milestone3.Model.CardSideModel.Color.NONE,
                    Milestone3.Model.CardSideModel.Type.WILD));
            this.lightSides.add(new Milestone3.Model.CardSideModel(Milestone3.Model.CardSideModel.Color.NONE,
                    Milestone3.Model.CardSideModel.Type.WILD_DRAW_TWO));
            this.darkSides.add(new Milestone3.Model.CardSideModel(Milestone3.Model.CardSideModel.Color.NONE,
                    Milestone3.Model.CardSideModel.Type.WILD));
            this.darkSides.add(new Milestone3.Model.CardSideModel(Milestone3.Model.CardSideModel.Color.NONE,
    ...
    public void createDeck() {
        ...
        for (int i = 0; i < this.darkSides.size(); i++) {
            this.cards.add(new Milestone3.Model.CardModel(this.lightSides.get(i), this.darkSides.get(i)));
        }
    }
